...
public class Conexion {
    ...
    public static Connection getConexion(){
        status = false;
        String url = "jdbc:sqlserver://localhost:49162;databaseName=CCEPC";
        ...
        try{
            ...
            "Error deeee Conexion",JOptionPane.ERROR_MESSAGE);
        }
        return status;
    }
    
    public static Connection MasterConexion(){
        status = false;
        String user = "jesusavh";
        String password = "123";
        String url = "jdbc:sqlserver://localhost:49162;databaseName=master";
